...
export default class BuyView extends React.Component {
	...
	componentDidMount() {
		...
		document.getElementById('univ-drop-down').innerHTML = university;
		document.getElementById('minbed-drop-down').innerHTML = minbed;
		document.getElementById('maxbed-drop-down').innerHTML = maxbed;
		document.getElementById('minbath-drop-down').innerHTML = minbath;
		document.getElementById('maxbath-drop-down').innerHTML = maxbath;
		document.getElementById('radius').innerHTML = radius;
		document.getElementById('minprice-drop-down').innerHTML = minprice;
		document.getElementById('maxprice-drop-down').innerHTML = maxprice;
