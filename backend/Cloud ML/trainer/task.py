...
TEMP_DIR = 'tmp/'
DATA_FILE_NAME = 'import argparse
from . import model
import numpy as np
import tensorflow as tf
import os
...
WORKING_DIR = os.getcwd()
TEMP_DIR = 'tmp/'
DATA_FILE_NAME = 'yelp_academic_dataset_review.'csv
...
def load_data(path='yelp_academic_dataset_review.csv', test_split=0.2, seed=113):
